...
\noindent Teaching assistants: Bianca Doone, Yukun Li\\
...
\noindent Homework/Labs (40\%): There will be approximately six lab assignments and additional biweekly challenges that you will complete over the course of the semester. Each assignment will have components that you will hand in for grading. Assignments and due dates will be posted in advance on the course website. The assignments will be graded. Some assignments will require you to submit a digital file with reproducible solutions, i.e. a knitr file that reproduces your answers. Late homeworks will not be accepted under any circumstances. If a homework is not handed in on time, it will receive a grade of zero. I will drop your lowest homework grade when calculating your final grade.\\
...
\noindent {\bf Attendance:} Attendance is required. Absences (excused or not) will impact your participation grade.\\
