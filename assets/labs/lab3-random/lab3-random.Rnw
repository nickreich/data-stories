...
\section*{Lab 3: Is an iPod's shuffle random?}

\subsection*{Overview}
This is an assignment that you will work on first individually, then in groups of 4-5 students. The overall goal is to develop and validate a set of rules (a model!) for determining whether a given playlist of songs is ``random'' or not.

\subsection*{The assignment}
The deliverable for this lab is a single page writeup in the form of a letter to Mr. Hoffman (more details are given in Part V on page 4 of this assignment). The single page should contain all group members' full names and be submitted to the instructors via Piazza by 5pm on Thursday, October 6. All group members will receive the same number of points (out of 50), based on the letter.
...
He has claimed that the iPod Shuffle feature is not generating random playlists. As evidence, Mr. Hoffman has provided both his \href{https://raw.githubusercontent.com/nickreich/data-stories/gh-pages/assets/labs/lab3-random/Albert-Hoffman-Music-Library.csv}{music library} (8 artists with 10 songs each) and three playlists (20 songs each) that his iPod generated using the shuffle feature.
...
Examine the \href{https://github.com/nickreich/data-stories/raw/gh-pages/assets/labs/lab3-random/Albert-Hoffman-Playlists.pdf}{25 randomly generated playlists} to get an idea of the characteristics of these lists. Write down and number two or more characteristics of a randomly generated playlist in the space below.
