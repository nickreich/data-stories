...
% Multiple terms for this concept:
%
% \begin{itemize}
%   \item ``case'': used by our textbook, I find it vague
%   \item ``observation'': prefered
% \end{itemize}
...
\bi
\myitem {\bf Population}: ``set of all possible units which might have been included'' (Daniel Kaplan)\\
\myitem {\bf Sampling frame}: ``a list of the items or people forming a population from which a sample is taken'' (Oxford/Google) \\
\myitem {\bf Sample}: ``a selection of cases from the population`` (Daniel Kaplan)
\ei
