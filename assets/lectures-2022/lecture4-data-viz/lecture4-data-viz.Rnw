...
\includegraphics[width=.75\textwidth]{figure-static/blakely-deficit-framed-line-chart-example-redraw.png}
...
\includegraphics[width=.75\textwidth]{figure-static/bar-vs-jitter-exp1.png}
...
\includegraphics[width=\textwidth]{figure-static/exp2-result-summary.png}
