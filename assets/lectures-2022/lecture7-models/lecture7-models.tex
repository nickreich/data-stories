...
\begin{frame}[fragile]{Lung data example: looking at the data}
...
\hlstd{dat} \hlkwb{<-} \hlkwd{read.table}\hlstd{(}\hlstr{"../../data/lungc.txt"}\hlstd{,} \hlkwc{header}\hlstd{=}\hlnum{TRUE}\hlstd{)} \hlopt{%>%}
  \hlkwd{mutate}\hlstd{(}\hlkwc{smoking} \hlstd{=} \hlkwd{factor}\hlstd{(smoking,}
                          \hlkwc{levels}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{0}\hlstd{,}\hlnum{1}\hlstd{),}
                          \hlkwc{labels}\hlstd{=}\hlkwd{c}\hlstd{(}\hlstr{"non-smoker"}\hlstd{,} \hlstr{"smoker"}\hlstd{)))}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{ggplot}\hlstd{(dat,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=disease))} \hlopt{+} \hlkwd{geom_dotplot}\hlstd{()}
\end{alltt}
\end{kframe}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{ggplot}\hlstd{(dat,} \hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=}\hlnum{1}\hlstd{,} \hlkwc{y}\hlstd{=disease))} \hlopt{+} \hlkwd{geom_dotplot}\hlstd{(}\hlkwc{binaxis}\hlstd{=}\hlstr{"y"}\hlstd{)} \hlopt{+}
  \hlkwd{geom_hline}\hlstd{(}\hlkwc{yintercept} \hlstd{=} \hlkwd{mean}\hlstd{(dat}\hlopt{$}\hlstd{disease),} \hlkwc{linetype}\hlstd{=}\hlnum{2}\hlstd{)}
\end{alltt}
\end{kframe}
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/lung-plot-main-terms-1} 
\end{knitrout}
