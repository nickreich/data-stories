...
\begin{frame}{The Bachelorette\footnote{https://fivethirtyeight.com/features/the-bachelorette/}}

\centering 

\includegraphics[width=\textwidth]{../lecture1-intro-regression/figure-static/koeze-hickey-bachelor-5-edited.png}
